...
router
  ...
  .get(authorizationMiddleware(['admin']), brandingController.getCustomization);

router
  .route('/create-customization')
  .post(authorizationMiddleware(['admin']), brandingController.createCustomization);

router
  .route('/update-customization')
  .put(authorizationMiddleware(['admin']), brandingController.updateCustomization);
