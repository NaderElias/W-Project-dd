...
router
  ...
  .put(authorizationMiddleware(['user', 'admin', 'manager', 'agent']), userController.updateProfile);

router
  .route('/get-profile')
  .get(authorizationMiddleware(['user', 'admin', 'manager', 'agent']), userController.getProfile);
